const ResourceContent = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 bg-[#F5F5F0] dark:bg-[#1A2A40]/10 rounded-lg">
      ...
      <section className="mb-10">
        ...
        <p className="text-[#1A2A40]/80 dark:text-[#F5F5F0]/80 leading-relaxed">
      ...
      <section className="mb-10">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div 
                key={index} 
                className="bg-white dark:bg-[#1A2A40]/40 p-4 rounded-lg shadow-md border-l-4 border-[#D47D5A] hover:shadow-lg transition-shadow duration-300"
              >
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {[
              ...
              <div 
                key={index} 
                className="bg-white dark:bg-[#1A2A40]/40 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-[#87A28F]"
              >
                <h4 className="font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-1">{item.title}</h4>
                <p className="text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white dark:bg-[#1A2A40]/30 rounded-lg overflow-hidden shadow-md">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Systèmes de caisse traditionnels</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Écrans tactiles</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Familiarité, robustesse</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Coûteux, encombrants, formation complexe</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Interface vocale, pas d'écran, intégration complète</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Solutions mobiles (tablettes)</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Applications sur tablettes</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Mobilité, coût initial réduit</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Fragilité, distractions, batterie</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Mains libres, attention non divisée</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Caisses cloud</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">SaaS avec matériel</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Mises à jour automatiques, données centralisées</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Dépendance internet, toujours des écrans</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Interface naturelle, apprentissage intuitif</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Assistants vocaux génériques</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">IA vocale grand public</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Reconnaissance vocale</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Non spécialisés pour la restauration</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Vocabulaire spécifique, intégration métier</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="mb-10">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#D47D5A]">
              <div className="p-5">
                <h4 className="font-bold text-lg text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Restaurants indépendants premium</h4>
                <ul className="space-y-2 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
            ...
            <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#87A28F]">
              <div className="p-5">
            ...
            <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 border-t-4 border-[#D4B483]">
              <div className="p-5">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
      ...
      <section className="mb-10">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden">
            <div className="bg-[#1A2A40] dark:bg-[#D47D5A] text-white p-4">
          ...
          <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-5">
              <p className="font-semibold mb-3 text-[#1A2A40] dark:text-[#F5F5F0]">
                <span className="text-[#87A28F]">Objectif :</span> Atteindre 50 établissements actifs dans 3 zones géographiques prioritaires
              </p>
              <ul className="space-y-2 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
                <li className="flex items-start">
                  <span className="text-[#87A28F] mr-2">•</span>
          ...
          <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-5">
              <p className="font-semibold mb-3 text-[#1A2A40] dark:text-[#F5F5F0]">
                <span className="text-[#D4B483]">Objectif :</span> Atteindre 300+ établissements et préparer l'internationalisation
              </p>
              <ul className="space-y-2 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
                <li className="flex items-start">
                  <span className="text-[#D4B483] mr-2">•</span>
      ...
      <section className="mb-10">
        ...
        <div className="mb-8">
          ...
          <div className="bg-white dark:bg-[#1A2A40]/40 p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                <div 
                  key={index} 
                  className={`p-4 rounded-lg ${item.color} border-l-4 shadow hover:shadow-md transition-shadow duration-300 bg-white/50 dark:bg-[#1A2A40]/20`}
                >
        ...
        <div className="mb-8">
          ...
          <div className="bg-white dark:bg-[#1A2A40]/40 p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="space-y-6">
              <div className="flex flex-col md:flex-row md:items-center p-4 bg-[#F5F5F0] dark:bg-[#1A2A40]/60 rounded-lg">
                ...
                <div className="md:w-2/3">
                  ...
                  <span className="text-[#1A2A40]/70 dark:text-[#F5F5F0]/70 ml-2">(offerts pour les 50 premiers clients)</span>
                </div>
              </div>
              
              <div className="flex flex-col p-4 bg-[#F5F5F0] dark:bg-[#1A2A40]/60 rounded-lg">
                ...
                <div className="mb-2">
                  ...
                  <span className="text-[#1A2A40]/70 dark:text-[#F5F5F0]/70 ml-2">pour un établissement standard</span>
                </div>
                <ul className="space-y-1 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80 ml-4">
                  <li className="flex items-start">
                    <span className="text-[#87A28F] mr-2">•</span>
            ...
            <table className="min-w-full bg-white dark:bg-[#1A2A40]/30 rounded-lg overflow-hidden shadow-md">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  ...
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Prix standard avec options à la carte</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Amélioration de l'expérience client et image de marque</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Petits groupes</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Remise volume progressive</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Cohérence d'opération et données centralisées</td>
                </tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="py-3 px-4 text-[#1A2A40] dark:text-[#F5F5F0]">Concepts nouvelle génération</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Forfait tout inclus avec analytics</td>
                  <td className="py-3 px-4 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">Différenciation et innovation visible</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            {[
              ...
              <div 
                key={index} 
                className={`bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 ${phase.color} border-t-4`}
              >
                <div className="p-5">
                  <h4 className="font-bold text-lg text-[#1A2A40] dark:text-[#F5F5F0] mb-3">{index + 1}. {phase.title}</h4>
                  <ul className="space-y-2">
                    {phase.items.map((item, idx) => (
                      <li key={idx} className="flex items-start text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
              ...
              {[
                ...
                <li key={index} className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-[#1A2A40]/70 dark:text-[#F5F5F0]/70">{item.description}</p>
                  </div>
                </li>
              ))}
            </ul>
      ...
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white dark:bg-[#1A2A40]/40 rounded-lg shadow-md overflow-hidden md:col-span-2">
            <div className="bg-[#D4B483] text-white p-4">
            ...
            <div className="p-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={idx} className="flex items-start text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
                    <span className="text-[#D4B483] mr-2">•</span>
                    <span>{item}</span>
                  </div>
                ))}
      ...
      <section className="mb-10">
        ...
        <div className="bg-white dark:bg-[#1A2A40]/40 p-6 rounded-lg shadow-md mb-8">
          <p className="text-[#1A2A40]/80 dark:text-[#F5F5F0]/80 leading-relaxed mb-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div 
                key={index} 
                className={`${item.color} border-l-4 p-4 rounded-lg flex flex-col md:flex-row md:items-center`}
              >
                ...
                <div className="flex flex-col md:flex-row md:w-1/2">
                  <div className="md:w-1/2 text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">
        ...
        <div className="bg-[#1A2A40] dark:bg-[#D47D5A]/90 text-white p-6 rounded-lg shadow-md">
