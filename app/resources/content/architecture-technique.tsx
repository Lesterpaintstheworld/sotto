  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 md:py-12 resource-content">
      <div className="mb-10 animate-float">
        <h1 className="text-4xl md:text-5xl font-bold text-[#1A2A40] mb-2">
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Introduction</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Vue d'ensemble de l'architecture</h2>
        <p className="text-lg leading-relaxed mb-6">
        ...
        <h3 className="text-xl font-semibold text-[#1A2A40] mb-4">Composants principaux</h3>
        
        <div className="overflow-x-auto mb-8">
          <table className="min-w-full bg-white rounded-lg overflow-hidden">
            <thead className="bg-[#1A2A40]">
              <tr>
                <th className="px-6 py-3 text-left text-sm font-semibold uppercase text-white">Composant</th>
                <th className="px-6 py-3 text-left text-sm font-semibold uppercase text-white">Description</th>
                <th className="px-6 py-3 text-left text-sm font-semibold uppercase text-white">Rôle</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
              <tr className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#1A2A40]">
                  <strong>Interface Vocale</strong>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-sm text-[#1A2A40]">
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">1. Interface Vocale</h2>
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 mb-8">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            {[
              ...
              <li key={index} className="bg-[#F5F5F0] p-4 rounded-lg shadow flex items-start hover:translate-y-[-2px] transition-transform duration-300">
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">2. Middleware IA</h2>
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 mb-8">
          ...
          <div className="bg-[#1A2A40] p-4 rounded-lg font-mono text-sm overflow-x-auto">
            <code className="text-[#F5F5F0]">
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">3. Backend Opérationnel</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">4. Infrastructure Cloud</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Flux de données et communication</h2>
        
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 mb-8">
          <h3 className="text-xl font-semibold text-[#1A2A40] mb-4">Cycle de vie d'une commande</h3>
        ...
        <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6 mb-8">
          <h3 className="text-xl font-semibold text-[#1A2A40] mb-4">Latence et performance</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={index} className="bg-[#F5F5F0] p-4 rounded-lg shadow text-center hover:scale-105 transition-transform duration-300">
                <p className="text-[#1A2A40]">{item}</p>
              </div>
            ))}
          </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Déploiement et installation</h2>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 p-6">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start bg-[#F5F5F0] p-3 rounded-lg">
                  <span className="text-[#D4B483] mr-2">•</span>
                  <span className="text-[#1A2A40]">{item}</span>
                </li>
              ))}
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Évolutivité et maintenance</h2>
      ...
      <section className="mb-12">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#1A2A40] mb-6">Conclusion</h2>
        <div className="bg-[#1A2A40] p-6 rounded-xl shadow-lg">
      ...
      <section className="mb-8">
        <h3 className="text-xl font-semibold text-[#1A2A40] mb-6">Prochaines étapes</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6 text-center">
            <div className="text-[#D47D5A] mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
              </svg>
            </div>
            <h4 className="font-semibold text-[#1A2A40] mb-2">Demander une démonstration</h4>
            <p className="text-[#1A2A40]">pour voir l'architecture Sotto en action dans votre établissement</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6 text-center">
            ...
            <h4 className="font-semibold text-[#1A2A40] mb-2">Consulter notre FAQ technique</h4>
            <p className="text-[#1A2A40]">pour des réponses aux questions spécifiques</p>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-md hover:shadow-lg hover:scale-105 transition-all duration-300 p-6 text-center">
            ...
            <h4 className="font-semibold text-[#1A2A40] mb-2">Contacter notre équipe d'experts</h4>
            <p className="text-[#1A2A40]">pour une évaluation personnalisée de vos besoins</p>
          </div>
        </div>
      </section>

      <div className="text-center italic text-[#1A2A40] mt-12 border-t border-gray-200 pt-6">
