    ...
    <div className="max-w-5xl mx-auto px-4 py-8 md:py-12">
      <div className="mb-12 border-b border-[#D47D5A]/30 pb-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <span className="px-3 py-1 rounded-full bg-[#87A28F]/10 text-[#87A28F] text-sm font-medium">
            ressource d'équipe
          </span>
        </div>
      </div>
      ...
      <section className="mb-12">
        ...
        <div className="prose prose-lg max-w-none dark:prose-invert prose-headings:text-[#1A2A40] dark:prose-headings:text-[#F5F5F0] prose-a:text-[#D47D5A]">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={index} className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#87A28F]/20 shadow-sm hover:shadow-md transition-shadow duration-300 hover:border-[#D47D5A]/30">
                <div className="flex items-start">
                  ...
                  <p className="text-[#1A2A40] dark:text-[#F5F5F0]/90">{item}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              <div key={index} className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#D4B483]/20 shadow-sm hover:shadow-md transition-shadow duration-300 hover:border-[#D4B483]/40">
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#D4B483]/10 flex items-center justify-center mr-3 mt-0.5">
                    <span className="text-[#D4B483] text-sm font-medium">{index + 1}</span>
                  </div>
                  <p className="text-[#1A2A40] dark:text-[#F5F5F0]/90">{item}</p>
                </div>
              </div>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white dark:bg-[#1A2A40]/30 rounded-lg overflow-hidden border border-[#87A28F]/20">
              <thead className="bg-[#87A28F]/10">
                <tr>
              ...
              <tbody className="divide-y divide-[#87A28F]/10">
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Diversité de format</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">Mélange de service à table, comptoir, hybride</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#D47D5A]/10 text-[#D47D5A] text-xs font-medium">
                      Élevée
                    </span>
                  </td>
                </tr>
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Taille</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">De 2-3 à 15 serveurs maximum pour la phase pilote</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#D47D5A]/10 text-[#D47D5A] text-xs font-medium">
                      Élevée
                    </span>
                ...
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Profil technologique</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">Mixture d'établissements tech-friendly et traditionnels</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#87A28F]/10 text-[#87A28F] text-xs font-medium">
                      Moyenne
                    </span>
                  </td>
                </tr>
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Infrastructure WiFi</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">Couverture existante suffisante ou possibilité d'amélioration</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#D4B483]/10 text-[#D4B483] text-xs font-medium">
                      Critique
                    </span>
                  </td>
                </tr>
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Engagement</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">Volonté de la direction de participer activement au test</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#D4B483]/10 text-[#D4B483] text-xs font-medium">
                      Critique
                    </span>
                ...
                <tr className="hover:bg-[#F5F5F0] dark:hover:bg-[#1A2A40]/50 transition-colors duration-150">
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/90 font-medium">Localisation</td>
                  <td className="px-4 py-3 text-sm text-[#1A2A40] dark:text-[#F5F5F0]/80">Accessibilité pour l'équipe technique en cas d'intervention</td>
                  <td className="px-4 py-3 text-sm">
                    <span className="px-2 py-1 rounded-full bg-[#87A28F]/10 text-[#87A28F] text-xs font-medium">
                      Moyenne
                    </span>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40] dark:text-[#F5F5F0]/90">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={index} className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#87A28F]/20 shadow-sm hover:shadow-md transition-shadow duration-300 hover:border-[#87A28F]/40 flex flex-col">
                {item.count && (
                  <div className="self-end mb-2 px-2 py-1 rounded-full bg-[#D47D5A]/10 text-[#D47D5A] text-xs font-medium">
                    x{item.count}
                  </div>
                )}
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">{item.type}</h4>
                <p className="text-sm text-[#1A2A40]/70 dark:text-[#F5F5F0]/70">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm hover:shadow-md transition-shadow duration-300 group">
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    ...
                    <span className="text-sm text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D4B483]/20 shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-3">
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Session initiale</h4>
                <span className="px-2 py-1 rounded-full bg-[#D4B483]/10 text-[#D4B483] text-xs font-medium">2h</span>
              </div>
              <ul className="space-y-2">
                {[
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D4B483]/20 shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="px-2 py-1 rounded-full bg-[#D4B483]/10 text-[#D4B483] text-xs font-medium">4h</span>
              </div>
              <ul className="space-y-2">
                {[
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D4B483]/20 shadow-sm hover:shadow-md transition-shadow duration-300">
              <div className="flex justify-between items-center mb-3">
                ...
                <span className="px-2 py-1 rounded-full bg-[#D4B483]/10 text-[#D4B483] text-xs font-medium">1 service</span>
              </div>
              <ul className="space-y-2">
                {[
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="relative pl-12">
                  ...
                  <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm">
                    <div className="flex justify-between items-center mb-3">
                      <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">{phase.phase}</h4>
                      <span className="px-2 py-1 rounded-full bg-[#87A28F]/10 text-[#87A28F] text-xs font-medium">{phase.duration}</span>
                    </div>
                    <ul className="space-y-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
            <div className="col-span-1">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#87A28F]/20 shadow-sm">
                  ...
                  <ul className="space-y-2">
                    {[
                      ...
                      <li key={i} className="flex items-start">
                        ...
                        <span className="text-xs text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item}</span>
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <div className="col-span-1">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#87A28F]/20 shadow-sm">
                  <h5 className="font-medium text-[#87A28F] mb-2 text-sm">Efficacité du service</h5>
                  <ul className="space-y-2">
                    {[
                ...
                <div className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#87A28F]/20 shadow-sm">
                  <h5 className="font-medium text-[#87A28F] mb-2 text-sm">Impact business</h5>
                  <ul className="space-y-2">
                    {[
            ...
            <div className="col-span-1">
              ...
              <div className="space-y-4">
                <div className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#D4B483]/20 shadow-sm">
                  <h5 className="font-medium text-[#D4B483] mb-2 text-sm">Satisfaction du personnel</h5>
                  <ul className="space-y-2">
                    {[
                ...
                <div className="bg-white dark:bg-[#1A2A40]/30 p-4 rounded-lg border border-[#D4B483]/20 shadow-sm">
                  <h5 className="font-medium text-[#D4B483] mb-2 text-sm">Satisfaction client</h5>
                  <ul className="space-y-2">
                    {[
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm">
                <h4 className="font-medium text-[#87A28F] mb-3">Télémétrie du système</h4>
                <ul className="space-y-2">
                  {[
              ...
              <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm">
                <h4 className="font-medium text-[#87A28F] mb-3">Questionnaires structurés</h4>
                <ul className="space-y-2">
                  {[
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D47D5A]/20 shadow-sm">
                <h4 className="font-medium text-[#D47D5A] mb-3">Entretiens individuels</h4>
                <ul className="space-y-2">
                  {[
              ...
              <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D47D5A]/20 shadow-sm">
                <h4 className="font-medium text-[#D47D5A] mb-3">Sessions d'observation</h4>
                <ul className="space-y-2">
                  {[
              ...
              <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D47D5A]/20 shadow-sm">
                <h4 className="font-medium text-[#D47D5A] mb-3">Journaux de bord</h4>
                <ul className="space-y-2">
                  {[
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div>
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm h-full">
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <span className="inline-block h-6 w-6 rounded-full bg-[#87A28F]/10 flex items-center justify-center mr-3 mt-0.5">
                      <span className="text-[#87A28F] text-sm font-medium">{i + 1}</span>
                    </span>
                    <span className="text-sm text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item}</span>
                  </li>
                ))}
          ...
          <div>
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D47D5A]/20 shadow-sm h-full">
              <div className="mb-4">
                <h4 className="font-medium text-[#D47D5A] mb-2">Ajustements mineurs</h4>
                <ul className="space-y-2">
                  {[
              ...
              <div>
                <h4 className="font-medium text-[#D47D5A] mb-2">Itérations majeures</h4>
                <ul className="space-y-2">
                  {[
          ...
          <div>
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#D4B483]/20 shadow-sm h-full">
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <span className="inline-block h-6 w-6 rounded-full bg-[#D4B483]/10 flex items-center justify-center mr-3 mt-0.5">
                      <span className="text-[#D4B483] text-sm font-medium">{i + 1}</span>
                    </span>
                    <span className="text-sm text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item}</span>
                  </li>
                ))}
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 p-5 rounded-lg border border-[#87A28F]/20 shadow-sm">
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-start">
                    <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#87A28F]/10 flex items-center justify-center mr-3 mt-0.5">
                      <span className="text-[#87A28F] text-sm font-medium">{i + 1}</span>
                    </div>
                    <span className="text-sm text-[#1A2A40]/80 dark:text-[#F5F5F0]/80">{item}</span>
                  </li>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 p-6 rounded-lg border border-[#D4B483]/20 shadow-md">
          <p className="text-lg leading-relaxed mb-4 text-[#1A2A40]/90 dark:text-[#F5F5F0]/90">
          ...
          <p className="text-lg leading-relaxed text-[#1A2A40]/90 dark:text-[#F5F5F0]/90">
      ...
      <section>
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 p-6 rounded-lg border border-[#D47D5A]/20 shadow-md">
          <ul className="space-y-3">
            {[
              ...
              <li key={i} className="flex items-start group">
                <div className="flex-shrink-0 h-6 w-6 rounded border border-[#D47D5A] mr-3 mt-0.5 flex items-center justify-center group-hover:bg-[#D47D5A]/10 transition-colors duration-300">
                ...
                <span className="text-[#1A2A40]/90 dark:text-[#F5F5F0]/90 group-hover:text-[#D47D5A] transition-colors duration-300">{item}</span>
              </li>
            ))}
          </ul>
        </div>
