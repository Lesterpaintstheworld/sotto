  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 md:py-12">
      <div className="mb-12 text-center">
        <h1 className="text-4xl md:text-5xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-4">
          Brand Book Sotto
        </h1>
      ...
      <section className="mb-16">
        ...
        <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
          <p className="text-[#505A64] dark:text-[#F5F5F0]/90 leading-relaxed">
      ...
      <section className="mb-16">
        ...
        <div className="mb-10">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            <p className="text-[#505A64] dark:text-[#F5F5F0]/90 leading-relaxed mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
                ...
                >
                  ...
                  <p className="text-[#505A64] dark:text-[#F5F5F0]/90">{item}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="mb-10">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            <p className="text-[#505A64] dark:text-[#F5F5F0]/90 leading-relaxed mb-6">
              ...
              <table className="min-w-full bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden">
                ...
                <tbody>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Discret</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80">Comme un bon serveur, Sotto est présent sans jamais s'imposer</td>
                  </tr>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Efficace</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80">Nous simplifions les tâches complexes avec une élégance naturelle</td>
                  </tr>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Élégant</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80">Notre approche privilégie la sobriété et le raffinement</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Attentif</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80">Nous anticipons les besoins avec une compréhension contextuelle</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="mb-16">
        ...
        <div className="mb-10">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            ...
            <div className="mb-8">
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Couleurs primaires:</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  ...
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Bleu profond</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#1A2A40</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Confiance, professionnalisme, stabilité</p>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  <div className="w-16 h-16 rounded-md bg-[#505A64] mr-4"></div>
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Gris ardoise</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#505A64</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Sophistication, neutralité</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Couleurs secondaires:</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  <div className="w-16 h-16 rounded-md bg-[#D47D5A] mr-4"></div>
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Terracotta doux</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#D47D5A</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Chaleur, hospitalité, lien avec la restauration</p>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  <div className="w-16 h-16 rounded-md bg-[#F5F5F0] border border-gray-200 dark:border-gray-700 mr-4"></div>
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Blanc cassé</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#F5F5F0</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Espace, clarté, simplicité</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mb-8">
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Accents:</h4>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  <div className="w-16 h-16 rounded-md bg-[#87A28F] mr-4"></div>
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Vert sauge</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#87A28F</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Fraîcheur, calme, naturel</p>
                  </div>
                </div>
                <div className="flex items-center p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden shadow-sm">
                  <div className="w-16 h-16 rounded-md bg-[#D4B483] mr-4"></div>
                  <div>
                    <p className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Or subtil</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">#D4B483</p>
                    <p className="text-sm text-[#505A64] dark:text-[#F5F5F0]/70">Qualité, excellence discrète</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Application des couleurs</h4>
              <ul className="space-y-2 text-[#505A64] dark:text-[#F5F5F0]/90">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            ...
            <div className="space-y-4 mb-6">
              <div className="p-3 bg-white dark:bg-[#1A2A40]/50 rounded-md">
                <p className="font-light text-lg text-[#1A2A40] dark:text-[#F5F5F0]">Geist Light — Grands blocs de texte, citations</p>
              </div>
              <div className="p-3 bg-white dark:bg-[#1A2A40]/50 rounded-md">
                <p className="font-normal text-lg text-[#1A2A40] dark:text-[#F5F5F0]">Geist Regular — Corps de texte standard</p>
              </div>
              <div className="p-3 bg-white dark:bg-[#1A2A40]/50 rounded-md">
                <p className="font-medium text-lg text-[#1A2A40] dark:text-[#F5F5F0]">Geist Medium — Sous-titres, emphase modérée</p>
              </div>
              <div className="p-3 bg-white dark:bg-[#1A2A40]/50 rounded-md">
                <p className="font-semibold text-lg text-[#1A2A40] dark:text-[#F5F5F0]">Geist SemiBold — Titres, points importants</p>
              </div>
              <div className="p-3 bg-white dark:bg-[#1A2A40]/50 rounded-md">
                <p className="font-bold text-lg text-[#1A2A40] dark:text-[#F5F5F0]">Geist Bold — Utilisé rarement, uniquement pour un impact maximal</p>
              </div>
            </div>
        ...
        <div className="mb-10">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            <div className="mb-8">
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Logo</h4>
              <p className="text-[#505A64] dark:text-[#F5F5F0]/90 leading-relaxed mb-4">
            ...
            <div className="mb-8">
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Règles d'utilisation du logo</h4>
              <ul className="space-y-2 text-[#505A64] dark:text-[#F5F5F0]/90">
                <li className="flex items-start">
                  <span className="inline-block w-2 h-2 rounded-full bg-[#D47D5A] mt-2 mr-2"></span>
            ...
            <div>
              <h4 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-3">Iconographie</h4>
              <p className="text-[#505A64] dark:text-[#F5F5F0]/90 leading-relaxed mb-4">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#1A2A40]">
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Concision</h4>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Nous allons droit au but, respectant le temps de nos interlocuteurs</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#D47D5A]">
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Clarté</h4>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Nous évitons le jargon technique inutile</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#87A28F]">
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Chaleur</h4>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Notre ton est professionnel mais jamais froid ou impersonnel</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#D4B483]">
                <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Contextualisation</h4>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Nous adaptons notre communication au contexte et à l'interlocuteur</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            <div className="overflow-x-auto">
              <table className="min-w-full bg-white dark:bg-[#1A2A40]/50 rounded-lg overflow-hidden">
                ...
                <tbody>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Confirmation de commande</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-red-50 dark:bg-red-900/10">"Votre requête a été traitée avec succès"</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-green-50 dark:bg-green-900/10">"Commande enregistrée pour la table 12"</td>
                  </tr>
                  <tr className="border-b border-gray-200 dark:border-gray-700">
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Assistance</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-red-50 dark:bg-red-900/10">"Une erreur système s'est produite"</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-green-50 dark:bg-green-900/10">"Je n'ai pas bien compris. Pourriez-vous reformuler?"</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Marketing</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-red-50 dark:bg-red-900/10">"Solution révolutionnaire basée sur l'IA"</td>
                    <td className="py-3 px-4 text-[#505A64] dark:text-[#F5F5F0]/80 bg-green-50 dark:bg-green-900/10">"Libérez votre restaurant des écrans et recentrez-vous sur l'essentiel"</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Tonalité</h4>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Moyenne-grave, rassurante sans être autoritaire</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-[#D47D5A]/20 flex items-center justify-center mr-2">
                  ...
                  <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Rythme</h4>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Naturel avec des pauses appropriées, jamais précipité</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-[#D47D5A]/20 flex items-center justify-center mr-2">
                  ...
                  <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Expressions</h4>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Humaines et contextuelles, évitant les formulations robotiques</p>
              </div>
              <div className="p-4 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm">
                <div className="flex items-center mb-2">
                  <div className="w-8 h-8 rounded-full bg-[#D47D5A]/20 flex items-center justify-center mr-2">
                  ...
                  <h4 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Confirmations</h4>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Brèves et claires, sans verbiage inutile</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-[#1A2A40]/50 p-5 rounded-lg shadow-sm">
                <div className="h-40 bg-[#1A2A40]/10 dark:bg-[#F5F5F0]/10 rounded-md mb-4 flex items-center justify-center">
                  <span className="text-[#1A2A40] dark:text-[#F5F5F0] font-medium">Authenticité</span>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Situations réelles de service, jamais artificielles</p>
              </div>
              
              <div className="bg-white dark:bg-[#1A2A40]/50 p-5 rounded-lg shadow-sm">
                <div className="h-40 bg-[#1A2A40]/10 dark:bg-[#F5F5F0]/10 rounded-md mb-4 flex items-center justify-center">
                  <span className="text-[#1A2A40] dark:text-[#F5F5F0] font-medium">Éclairage naturel</span>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Ambiance chaleureuse et accueillante</p>
              </div>
              
              <div className="bg-white dark:bg-[#1A2A40]/50 p-5 rounded-lg shadow-sm">
                <div className="h-40 bg-[#1A2A40]/10 dark:bg-[#F5F5F0]/10 rounded-md mb-4 flex items-center justify-center">
                  <span className="text-[#1A2A40] dark:text-[#F5F5F0] font-medium">Focus humain</span>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">L'accent est mis sur les personnes et les interactions</p>
              </div>
              
              <div className="bg-white dark:bg-[#1A2A40]/50 p-5 rounded-lg shadow-sm">
                <div className="h-40 bg-[#1A2A40]/10 dark:bg-[#F5F5F0]/10 rounded-md mb-4 flex items-center justify-center">
                  <span className="text-[#1A2A40] dark:text-[#F5F5F0] font-medium">Absence d'écrans</span>
                </div>
                <p className="text-[#505A64] dark:text-[#F5F5F0]/80">Conformément à notre mission, nos visuels montrent des espaces libérés des interfaces technologiques</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-10">
          ...
          <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
            ...
            <ul className="space-y-3 text-[#505A64] dark:text-[#F5F5F0]/90">
        ...
        <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 p-6 rounded-lg shadow-md border border-[#1A2A40]/10 dark:border-[#F5F5F0]/10">
          ...
          <div className="space-y-6">
            <div className="p-5 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#D47D5A]">
              <h3 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Pour les propriétaires:</h3>
              <blockquote className="text-[#505A64] dark:text-[#F5F5F0] italic pl-4 border-l-2 border-[#D47D5A]/30">
            ...
            <div className="p-5 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#87A28F]">
              <h3 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Pour le personnel:</h3>
              <blockquote className="text-[#505A64] dark:text-[#F5F5F0] italic pl-4 border-l-2 border-[#87A28F]/30">
            ...
            <div className="p-5 bg-white dark:bg-[#1A2A40]/50 rounded-lg shadow-sm border-l-4 border-[#D4B483]">
              <h3 className="text-lg font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">Pour les clients finaux:</h3>
              <blockquote className="text-[#505A64] dark:text-[#F5F5F0] italic pl-4 border-l-2 border-[#D4B483]/30">
      ...
      <section>
        <div className="bg-[#1A2A40] dark:bg-[#D47D5A] text-white p-6 rounded-lg shadow-md">
          ...
          <p className="text-center font-medium">
            <a href="mailto:brand@sotto.ai" className="underline hover:text-[#D4B483] transition-colors">
              brand@sotto.ai
            </a>
          </p>
        </div>
