const ResourceContent = () => {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-6">Principes généraux de formation</h2>
        
        <div className="mb-8">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Philosophie d'apprentissage</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-[#87A28F]/20 hover:border-[#87A28F]/40">
              <div className="flex items-center mb-3">
                <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">1</span>
                <h4 className="font-semibold text-[#1A2A40] dark:text-[#F5F5F0]">Progressivité</h4>
              </div>
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-[#87A28F]/20 hover:border-[#87A28F]/40">
              <div className="flex items-center mb-3">
                <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">2</span>
                <h4 className="font-semibold text-[#1A2A40] dark:text-[#F5F5F0]">Contextualisation</h4>
              </div>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
            ...
            <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border border-[#87A28F]/20 hover:border-[#87A28F]/40">
              <div className="flex items-center mb-3">
                <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">3</span>
                <h4 className="font-semibold text-[#1A2A40] dark:text-[#F5F5F0]">Autonomisation</h4>
              </div>
              <p className="text-gray-600 dark:text-gray-300 text-sm">
        ...
        <div className="mb-8">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Structure des sessions</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <div className="overflow-x-auto rounded-lg border border-[#87A28F]/20 shadow-md">
            <table className="min-w-full divide-y divide-[#87A28F]/20">
              <thead className="bg-[#F5F5F0] dark:bg-[#1A2A40]">
                <tr>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Phase</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Durée</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Objectif</th>
                  <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Méthode</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-[#1A2A40]/20 divide-y divide-[#87A28F]/20">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Découverte</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">30 min</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Familiarisation avec le matériel et concepts</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Présentation, manipulation</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Démonstration</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">45 min</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Visualisation des cas d'usage</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Mise en situation par le formateur</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Pratique guidée</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">1h30</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Utilisation assistée</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Exercices supervisés</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Autonomie</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">1h</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Utilisation indépendante</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">Mise en situation réelle avec support à distance</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-8">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Indicateurs de réussite</h3>
          <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-6">Formation des serveurs</h2>
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg mb-8 border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Session 1: Prise en main du matériel</h3>
          ...
          <div className="mb-6">
            ...
            <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg border-l-4 border-[#D47D5A] text-sm text-gray-700 dark:text-gray-300 italic">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">1. Mise en place de l'oreillette</h5>
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">2. Familiarisation avec les commandes tactiles</h5>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">3. Reconnaissance des signaux</h5>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg mb-8 border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Session 2: Commandes vocales fondamentales</h3>
          ...
          <div className="mb-6">
            ...
            <div className="overflow-x-auto rounded-lg border border-[#87A28F]/20">
              <table className="min-w-full divide-y divide-[#87A28F]/20">
                <thead className="bg-[#F5F5F0] dark:bg-[#1A2A40]">
                  <tr>
                    <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Commande</th>
                    <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Fonction</th>
                    <th scope="col" className="px-4 py-3 text-left text-xs font-medium text-[#1A2A40] dark:text-[#F5F5F0] uppercase tracking-wider">Exemple</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-[#1A2A40]/20 divide-y divide-[#87A28F]/20">
                  {[
                    ...
                    <tr key={index}>
                      <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-[#1A2A40] dark:text-[#F5F5F0]">{item.cmd}</td>
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{item.func}</td>
                      <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-600 dark:text-gray-300">{item.ex}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">1. Scénario simple</h5>
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">2. Scénario avec modifications</h5>
                <div className="text-sm text-gray-600 dark:text-gray-300 italic">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">3. Scénario complexe</h5>
                <div className="text-sm text-gray-600 dark:text-gray-300 italic">
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Session 3: Gestion des situations spéciales</h3>
          ...
          <div>
            ...
            <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg space-y-3">
              <div className="flex">
                <div className="w-24 flex-shrink-0 font-medium text-[#1A2A40] dark:text-[#F5F5F0] text-right pr-3">Serveur:</div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-6">Formation des cuisiniers</h2>
        
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg mb-8 border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Communication avec la salle</h3>
          ...
          <div className="mb-6">
            ...
            <div className="space-y-4">
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <div className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-2">
                  <span className="inline-block px-2 py-1 bg-[#87A28F] text-white rounded mr-2 text-xs">Commande</span>
                  "Prêt [détail]"
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Signaler un plat prêt à être servi</p>
                <div className="text-sm text-gray-600 dark:text-gray-300 italic pl-4 border-l-2 border-[#D47D5A]">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Informer d'un retard</p>
                <div className="text-sm text-gray-600 dark:text-gray-300 italic pl-4 border-l-2 border-[#D47D5A]">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">Signaler un problème d'approvisionnement</p>
                <div className="text-sm text-gray-600 dark:text-gray-300 italic pl-4 border-l-2 border-[#D47D5A]">
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg border-t-4 border-[#87A28F]">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-1">Priorité standard</h5>
                <p className="text-sm text-gray-600 dark:text-gray-300">Ordre chronologique normal</p>
              </div>
              
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg border-t-4 border-[#D4B483]">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-1">Priorité haute</h5>
                <p className="text-sm text-gray-600 dark:text-gray-300">Tables VIP, clients pressés (signalés par la salle)</p>
              </div>
              
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg border-t-4 border-[#D47D5A]">
                <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-1">Priorité urgente</h5>
                <p className="text-sm text-gray-600 dark:text-gray-300">Situations exceptionnelles nécessitant une action immédiate</p>
              </div>
            </div>
          </div>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-6">Formation des managers</h2>
        
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg mb-8 border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Supervision et analytics</h3>
          ...
          <div>
            ...
            <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg space-y-3">
              ...
              <div className="flex">
                <div className="w-24 flex-shrink-0 font-medium text-[#1A2A40] dark:text-[#F5F5F0] text-right pr-3">Manager:</div>
                <div className="flex-1 text-sm text-gray-600 dark:text-gray-300 italic">
        ...
        <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
          <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Gestion des problèmes courants</h3>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">1</span>
                  <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Identification</h5>
                </div>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">2</span>
                  <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Isolation</h5>
                </div>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">3</span>
                  <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Résolution</h5>
                </div>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
              ...
              <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/50 p-4 rounded-lg">
                <div className="flex items-center mb-3">
                  <span className="w-8 h-8 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3">4</span>
                  <h5 className="font-medium text-[#1A2A40] dark:text-[#F5F5F0]">Compensation</h5>
                </div>
                <ul className="list-disc pl-5 space-y-1 text-sm text-gray-600 dark:text-gray-300">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-6">Évaluation et suivi</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
            <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Métriques d'adoption</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
          ...
          <div className="bg-white dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg border border-[#87A28F]/20 hover:border-[#87A28F]/40 transition-all">
            <h3 className="text-xl font-medium text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Sessions de perfectionnement</h3>
            <p className="text-gray-700 dark:text-gray-300 mb-4">
            ...
            <ol className="space-y-3">
              {[
                ...
                <li key={index} className="flex items-start">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-[#1A2A40] dark:bg-[#D47D5A] text-white flex items-center justify-center font-bold mr-3 mt-0.5">{index + 1}</span>
                  <span className="text-gray-700 dark:text-gray-300">{item}</span>
                </li>
              ))}
            </ol>
      ...
      <section>
        <div className="bg-[#F5F5F0] dark:bg-[#1A2A40]/30 rounded-xl p-6 shadow-lg border border-[#87A28F]/20">
          <h2 className="text-xl font-semibold text-[#1A2A40] dark:text-[#F5F5F0] mb-4">Pour aller plus loin:</h2>
