    ...
    <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 resource-content">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
          <div className="bg-[#F5F5F0] p-6 rounded-lg shadow-md border-l-4 border-[#D47D5A] hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-[#1A2A40]">Entre le personnel équipé d'oreillettes</p>
          </div>
          <div className="bg-[#F5F5F0] p-6 rounded-lg shadow-md border-l-4 border-[#87A28F] hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-[#1A2A40]">Des commandes vers la cuisine</p>
          </div>
          <div className="bg-[#F5F5F0] p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-[#1A2A40]">Avec le système de gestion</p>
          </div>
          <div className="bg-[#F5F5F0] p-6 rounded-lg shadow-md border-l-4 border-[#1A2A40] hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <p className="text-[#1A2A40]">Pour votre équipe et vos clients</p>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Avant toute modification, évaluez votre situation actuelle :</p>
          ...
          <div className="space-y-4 my-6">
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-[#1A2A40]">Identifiez les zones principales (salle, cuisine, bar, terrasse)</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-[#1A2A40]">Utilisez une application de mesure WiFi dans chaque zone</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-[#1A2A40]">Repérez les endroits où le signal est faible ou inexistant</p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="text-[#1A2A40]">Les performances peuvent varier selon l'affluence</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Examinez les caractéristiques techniques de votre installation :</p>
          
          <div className="overflow-x-auto">
            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
              <thead className="bg-[#1A2A40]">
                <tr>
                  <th className="py-3 px-4 text-left text-white">Paramètre</th>
                  <th className="py-3 px-4 text-left text-white">Minimum recommandé</th>
                  <th className="py-3 px-4 text-left text-white">Optimal pour Sotto</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Débit descendant</td>
                  <td className="py-3 px-4 text-[#1A2A40]">25 Mbps</td>
                  <td className="py-3 px-4 text-[#87A28F] font-medium">100+ Mbps</td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Débit montant</td>
                  <td className="py-3 px-4 text-[#1A2A40]">10 Mbps</td>
                  <td className="py-3 px-4 text-[#87A28F] font-medium">50+ Mbps</td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Latence</td>
                  <td className="py-3 px-4 text-[#1A2A40]">{'< 50ms'}</td>
                  <td className="py-3 px-4 text-[#87A28F] font-medium">{'< 20ms'}</td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Stabilité</td>
                  <td className="py-3 px-4 text-[#1A2A40]">99%</td>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-[#1A2A40]">5 GHz</td>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Les restaurants présentent des défis spécifiques pour la propagation WiFi :</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow border-l-4 border-[#D47D5A]">
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Équipements de cuisine</strong> générant des interférences électromagnétiques</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow border-l-4 border-[#D47D5A]">
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Matériaux de construction</strong> (métal, béton épais) bloquant le signal</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow border-l-4 border-[#D47D5A]">
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Appareils concurrents</strong> (micro-ondes, téléphones sans fil) sur les mêmes fréquences</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow border-l-4 border-[#D47D5A]">
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Réseaux voisins</strong> saturant les canaux disponibles</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Le positionnement est crucial pour une couverture optimale :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
            <div className="bg-white p-5 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-[#1A2A40]">2-2,5m du sol, à distance des murs et obstacles métalliques</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-all duration-300">
              <h4 className="font-semibold text-[#1A2A40] mb-2">Couverture à 360°</h4>
              <p className="text-[#1A2A40]">Placez les points d'accès au centre des zones à couvrir</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-all duration-300">
              <h4 className="font-semibold text-[#1A2A40] mb-2">Zones critiques</h4>
              <p className="text-[#1A2A40]">Assurez une couverture renforcée en cuisine et dans les zones de service</p>
            </div>
            <div className="bg-white p-5 rounded-lg shadow-md border border-gray-200 hover:shadow-lg transition-all duration-300">
              <h4 className="font-semibold text-[#1A2A40] mb-2">Évitez la proximité</h4>
              <p className="text-[#1A2A40]">Avec les équipements électriques générant des interférences</p>
            </div>
          </div>
          
          <div className="bg-[#1A2A40] p-6 rounded-lg shadow-lg my-6 border-l-4 border-[#D47D5A]">
            <p className="font-bold mb-2 text-white">Conseil Sotto</p>
            <p className="text-white">Pour un restaurant de taille moyenne (100-150m²), prévoyez au minimum deux points d'accès de qualité professionnelle plutôt qu'un seul routeur grand public.</p>
          </div>
        </div>

        <div className="mb-8">
          <h3 className="text-xl font-medium text-[#1A2A40] mb-4">Configuration optimale</h3>
          <p className="mb-4 text-[#1A2A40]">Paramétrez votre réseau pour des performances optimales :</p>
          ...
          <ul className="space-y-3 my-6">
            <li className="flex items-start">
              ...
              <span className="ml-3 text-[#1A2A40]"><strong className="text-[#1A2A40]">Séparez les réseaux</strong> : Créez un SSID dédié pour Sotto, distinct du WiFi client</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#87A28F] flex items-center justify-center text-white mt-0.5">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="ml-3 text-[#1A2A40]"><strong className="text-[#1A2A40]">Priorisez le trafic</strong> : Configurez la QoS (Quality of Service) pour donner priorité aux appareils Sotto</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#87A28F] flex items-center justify-center text-white mt-0.5">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="ml-3 text-[#1A2A40]"><strong className="text-[#1A2A40]">Sélectionnez les canaux WiFi</strong> les moins encombrés (utilisez un analyseur de spectre)</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#87A28F] flex items-center justify-center text-white mt-0.5">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="ml-3 text-[#1A2A40]"><strong className="text-[#1A2A40]">Activez le band steering</strong> pour basculer intelligemment entre 2.4 GHz et 5 GHz</span>
            </li>
            <li className="flex items-start">
              <div className="flex-shrink-0 h-6 w-6 rounded-full bg-[#87A28F] flex items-center justify-center text-white mt-0.5">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
              ...
              <span className="ml-3 text-[#1A2A40]"><strong className="text-[#1A2A40]">Mettez à jour régulièrement</strong> le firmware de vos équipements réseau</span>
            </li>
          </ul>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">La sécurité est essentielle pour protéger vos données et celles de vos clients :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-6">
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Utilisez le WPA3</strong> ou au minimum WPA2-Enterprise pour le réseau Sotto</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              <div className="h-10 w-10 rounded-full bg-[#1A2A40] text-white flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Changez les identifiants par défaut</strong> de tous vos équipements réseau</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              <div className="h-10 w-10 rounded-full bg-[#1A2A40] text-white flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Activez le filtrage MAC</strong> pour les appareils Sotto</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              <div className="h-10 w-10 rounded-full bg-[#1A2A40] text-white flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Isolez le réseau professionnel</strong> du réseau client</p>
            </div>
            <div className="bg-[#F5F5F0] p-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-300">
              <div className="h-10 w-10 rounded-full bg-[#1A2A40] text-white flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <p className="text-[#1A2A40]"><strong className="text-[#1A2A40]">Mettez en place un pare-feu</strong> adapté à votre environnement</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Voici notre sélection d'équipements parfaitement compatibles avec Sotto :</p>
            ...
            <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
              <thead className="bg-[#1A2A40]">
                <tr>
                  ...
                  <th className="py-3 px-4 text-left text-white">Taille de restaurant</th>
                  <th className="py-3 px-4 text-left text-white">Caractéristiques</th>
                  <th className="py-3 px-4 text-left text-white">Prix indicatif</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Ubiquiti UniFi 6 Lite</td>
                  <td className="py-3 px-4 text-[#1A2A40]">Petit ({'< 100m²'})</td>
                  <td className="py-3 px-4 text-[#1A2A40]">WiFi 6, MIMO 2x2, jusqu'à 1.5 Gbps</td>
                  <td className="py-3 px-4 text-[#1A2A40]">90-120€</td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">TP-Link EAP245</td>
                  <td className="py-3 px-4 text-[#1A2A40]">Moyen (100-200m²)</td>
                  <td className="py-3 px-4 text-[#1A2A40]">WiFi 5, MIMO 3x3, jusqu'à 1.3 Gbps</td>
                  <td className="py-3 px-4 text-[#1A2A40]">80-100€</td>
                </tr>
                <tr className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Ubiquiti UniFi 6 Pro</td>
                  <td className="py-3 px-4 text-[#1A2A40]">Grand ({'> 200m²'})</td>
                  <td className="py-3 px-4 text-[#1A2A40]">WiFi 6, MIMO 4x4, jusqu'à 5.4 Gbps</td>
                  <td className="py-3 px-4 text-[#1A2A40]">160-190€</td>
                </tr>
                <tr className="hover:bg-gray-50">
                  <td className="py-3 px-4 font-medium text-[#1A2A40]">Cisco Meraki MR36</td>
                  <td className="py-3 px-4 text-[#1A2A40]">Tous formats avec gestion cloud</td>
                  <td className="py-3 px-4 text-[#1A2A40]">WiFi 6, gestion cloud, analytics</td>
                  <td className="py-3 px-4 text-[#1A2A40]">Abonnement</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Pour les espaces complexes ou sur plusieurs niveaux, un système maillé offre une couverture homogène :</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              <h4 className="font-semibold text-[#1A2A40] mb-3">Avantages</h4>
              <p className="text-[#1A2A40]">Transition transparente entre points d'accès, installation simplifiée</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
              <h4 className="font-semibold text-[#1A2A40] mb-3">Inconvénients</h4>
              <p className="text-[#1A2A40]">Coût plus élevé, performances légèrement réduites entre nœuds</p>
            </div>
          </div>
          
          <p className="mt-4 text-[#1A2A40]">
      ...
      <section className="mb-12">
            ...
            <div className="space-y-6 relative">
              <div className="flex">
                ...
                <div className="ml-6 bg-white p-4 rounded-lg shadow-md border border-gray-200 flex-grow">
                  ...
                  <p className="text-[#1A2A40]">Cartographiez votre espace et déterminez le placement optimal</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-6 bg-white p-4 rounded-lg shadow-md border border-gray-200 flex-grow">
                  ...
                  <p className="text-[#1A2A40]">Positionnez et configurez les points d'accès selon les recommandations</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-6 bg-white p-4 rounded-lg shadow-md border border-gray-200 flex-grow">
                  ...
                  <p className="text-[#1A2A40]">Créez un réseau dédié pour Sotto avec paramètres optimaux</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-6 bg-white p-4 rounded-lg shadow-md border border-gray-200 flex-grow">
                  ...
                  <p className="text-[#1A2A40]">Vérifiez la couverture et les performances dans toutes les zones</p>
                </div>
              </div>
              ...
              <div className="flex">
                ...
                <div className="ml-6 bg-white p-4 rounded-lg shadow-md border border-gray-200 flex-grow">
                  ...
                  <p className="text-[#1A2A40]">Affinez le placement et les paramètres selon les résultats</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-8">
          ...
          <p className="mb-4 text-[#1A2A40]">Après installation, validez que votre réseau répond aux exigences Sotto :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
            <div className="bg-[#F5F5F0] p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-start">
              ...
              <div>
                ...
                <p className="text-[#1A2A40]">Signal {'>'} -65 dBm dans toutes les zones opérationnelles</p>
              </div>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-start">
              ...
              <div>
                ...
                <p className="text-[#1A2A40]">Minimum 20 Mbps montant/descendant à chaque point de service</p>
              </div>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-start">
              ...
              <div>
                ...
                <p className="text-[#1A2A40]">{'< 30ms'} vers le serveur local Sotto</p>
              </div>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-start">
              ...
              <div>
                ...
                <p className="text-[#1A2A40]">Performances stables même aux heures de pointe</p>
              </div>
            </div>
            ...
            <div className="bg-[#F5F5F0] p-5 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 flex items-start">
              ...
              <div>
                ...
                <p className="text-[#1A2A40]">Passage fluide d'un point d'accès à l'autre</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white border border-gray-200 rounded-lg shadow-md">
            <thead className="bg-[#1A2A40]">
              <tr>
                <th className="py-3 px-4 text-left text-white">Problème</th>
            ...
            <tbody>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="py-3 px-4 font-medium text-[#1A2A40]">Zones sans couverture</td>
                <td className="py-3 px-4 text-[#1A2A40]">Obstacles, distance excessive</td>
                <td className="py-3 px-4 text-[#1A2A40]">Ajoutez un point d'accès ou répéteur</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="py-3 px-4 font-medium text-[#1A2A40]">Déconnexions fréquentes</td>
                <td className="py-3 px-4 text-[#1A2A40]">Interférences, surcharge</td>
                <td className="py-3 px-4 text-[#1A2A40]">Changez de canal, augmentez la puissance</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="py-3 px-4 font-medium text-[#1A2A40]">Latence élevée</td>
                <td className="py-3 px-4 text-[#1A2A40]">Congestion réseau, équipement obsolète</td>
                <td className="py-3 px-4 text-[#1A2A40]">Priorisation QoS, mise à niveau matérielle</td>
              </tr>
              <tr className="border-b border-gray-200 hover:bg-gray-50">
                <td className="py-3 px-4 font-medium text-[#1A2A40]">Signal faible</td>
                <td className="py-3 px-4 text-[#1A2A40]">Obstacles, puissance insuffisante</td>
                <td className="py-3 px-4 text-[#1A2A40]">Repositionnez les points d'accès, ajustez la puissance</td>
              </tr>
              <tr className="hover:bg-gray-50">
                <td className="py-3 px-4 font-medium text-[#1A2A40]">Performances réduites aux heures de pointe</td>
                <td className="py-3 px-4 text-[#1A2A40]">Bande passante insuffisante</td>
                <td className="py-3 px-4 text-[#1A2A40]">Augmentez votre forfait internet, optimisez la QoS</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="mb-12">
        ...
        <p className="mb-6 text-[#1A2A40]">Pour garantir des performances optimales dans la durée :</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-6">
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#1A2A40]">Les performances avec des outils comme WiFi Analyzer</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#1A2A40]">De couverture et de débit</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#1A2A40]">De vos équipements réseau tous les trimestres</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#1A2A40]">Après tout réaménagement de l'espace</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md border-l-4 border-[#D4B483] hover:shadow-lg transition-all duration-300">
            ...
            <p className="text-[#1A2A40]">Apportées à votre réseau</p>
          </div>
        </div>
      </section>
      ...
      <div className="bg-[#1A2A40] p-8 rounded-lg shadow-lg animate-float">
        <h3 className="text-xl font-bold mb-3 text-white">Besoin d'assistance pour optimiser votre réseau ?</h3>
