  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="mb-12 text-center">
        ...
        <div className="flex justify-center items-center space-x-3 text-sm text-gray-600 dark:text-gray-400">
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">Notre analyse s'appuie sur les données de 42 établissements partenaires répartis comme suit :</p>
          ...
          <div className="overflow-x-auto rounded-lg shadow-md mb-6">
            <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">Restaurant traditionnel</td>
                  <td className="px-6 py-4 whitespace-nowrap">18</td>
                  <td className="px-6 py-4 whitespace-nowrap">45</td>
                  <td className="px-6 py-4 whitespace-nowrap">6-12 mois</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="px-6 py-4 whitespace-nowrap">Bistrot/Brasserie</td>
                  <td className="px-6 py-4 whitespace-nowrap">12</td>
                  <td className="px-6 py-4 whitespace-nowrap">65</td>
                  <td className="px-6 py-4 whitespace-nowrap">8-14 mois</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 whitespace-nowrap">Restaurant gastronomique</td>
                  <td className="px-6 py-4 whitespace-nowrap">5</td>
                  <td className="px-6 py-4 whitespace-nowrap">30</td>
                  <td className="px-6 py-4 whitespace-nowrap">7-10 mois</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="px-6 py-4 whitespace-nowrap">Restaurant rapide qualitatif</td>
                  <td className="px-6 py-4 whitespace-nowrap">7</td>
                  <td className="px-6 py-4 whitespace-nowrap">80</td>
                  <td className="px-6 py-4 whitespace-nowrap">6-9 mois</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div>
          ...
          <p className="mb-4">Pour quantifier précisément le ROI, nous avons mesuré :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            {[
              ...
              <div key={index} className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow duration-300 border-l-4 border-[#87A28F]">
                <p className="text-[#1A2A40] dark:text-white">{item}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">L'adoption de Sotto a permis une diminution significative des investissements matériels et des coûts associés :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">Réduction moyenne des dépenses en équipement technologique</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              <div className="text-[#D47D5A] font-bold text-3xl mb-2">4 200€</div>
              <p className="text-gray-700 dark:text-gray-300">Économie annuelle en maintenance et mises à jour logicielles</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border border-gray-200 dark:border-gray-700">
              <div className="text-[#D47D5A] font-bold text-3xl mb-2">82%</div>
              <p className="text-gray-700 dark:text-gray-300">Diminution des incidents techniques nécessitant une intervention</p>
            </div>
          </div>
          
          <blockquote className="border-l-4 border-[#D4B483] pl-4 italic text-gray-700 dark:text-gray-300 my-6 bg-[#F5F5F0] dark:bg-gray-800 p-4 rounded-r-lg">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">L'efficacité accrue du service s'est traduite par des gains mesurables :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-gray-700 dark:text-gray-300">Réduction du temps de prise de commande</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
              <div className="text-[#87A28F] font-bold text-3xl mb-2">18%</div>
              <p className="text-gray-700 dark:text-gray-300">Diminution des erreurs de commande génératrices de gaspillage</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
              <div className="text-[#87A28F] font-bold text-3xl mb-2">12%</div>
              <p className="text-gray-700 dark:text-gray-300">Augmentation moyenne du nombre de couverts servis aux heures de pointe</p>
            </div>
          </div>
          
          <p className="mb-4">Ces améliorations ont un impact direct sur le chiffre d'affaires :</p>
        ...
        <div>
          ...
          <p className="mb-4">L'utilisation de Sotto a démontré une influence positive sur les comportements d'achat :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border-t-4 border-[#D4B483]">
              ...
              <p className="text-gray-700 dark:text-gray-300">Augmentation moyenne du panier grâce aux suggestions contextuelles intelligentes</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border-t-4 border-[#D4B483]">
              <div className="text-[#D4B483] font-bold text-3xl mb-2">+22%</div>
              <p className="text-gray-700 dark:text-gray-300">Hausse des ventes additionnelles (boissons, desserts, accompagnements)</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md border-t-4 border-[#D4B483]">
              <div className="text-[#D4B483] font-bold text-3xl mb-2">+17%</div>
              <p className="text-gray-700 dark:text-gray-300">Progression des ventes de plats à forte marge grâce aux recommandations personnalisées</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">Contrairement aux idées reçues, Sotto n'a pas réduit les effectifs mais a transformé leur utilisation :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-5 shadow hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center mb-3">
                ...
                <div className="ml-3 font-medium">Réallocation hebdomadaire</div>
              </div>
              <p className="text-gray-700 dark:text-gray-300">Réallocation moyenne de 15h/semaine du temps personnel vers des tâches à valeur ajoutée</p>
            </div>
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-5 shadow hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 rounded-full bg-[#87A28F] flex items-center justify-center text-white font-bold">35%</div>
                <div className="ml-3 font-medium">Formation optimisée</div>
              </div>
              <p className="text-gray-700 dark:text-gray-300">Réduction de 35% du temps consacré à la formation sur les systèmes d'encaissement</p>
            </div>
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-5 shadow hover:shadow-md transition-shadow duration-300">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 rounded-full bg-[#87A28F] flex items-center justify-center text-white font-bold">28%</div>
                <div className="ml-3 font-medium">Turnover réduit</div>
              </div>
              <p className="text-gray-700 dark:text-gray-300">Diminution de 28% du turnover du personnel de service</p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mb-4">L'intelligence prédictive de Sotto a permis :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 border-b-4 border-[#D47D5A]">
              <p className="font-semibold mb-2">Réduction des pertes alimentaires</p>
              <div className="text-[#D47D5A] font-bold text-3xl">-17%</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 border-b-4 border-[#D47D5A]">
              <p className="font-semibold mb-2">Diminution des coûts d'approvisionnement</p>
              <div className="text-[#D47D5A] font-bold text-3xl">-12%</div>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300 border-b-4 border-[#D47D5A]">
              <p className="font-semibold mb-2">Baisse des ruptures de stock</p>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">Les établissements utilisant Sotto ont observé :</p>
        ...
        <div>
          ...
          <p className="mb-4">Une enquête auprès de 1 200 clients de nos restaurants partenaires révèle :</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow border border-gray-200 dark:border-gray-700 hover:border-[#87A28F] transition-colors duration-300">
              ...
              <p className="text-gray-700 dark:text-gray-300">apprécient l'absence d'écrans et la présence plus attentive du personnel</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow border border-gray-200 dark:border-gray-700 hover:border-[#87A28F] transition-colors duration-300">
              <div className="text-[#87A28F] font-bold text-4xl mb-2">92%</div>
              <p className="text-gray-700 dark:text-gray-300">perçoivent l'établissement comme "innovant" et "à la pointe"</p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-5 shadow border border-gray-200 dark:border-gray-700 hover:border-[#87A28F] transition-colors duration-300">
              <div className="text-[#87A28F] font-bold text-4xl mb-2">78%</div>
              <p className="text-gray-700 dark:text-gray-300">mentionnent spontanément l'efficacité du service comme facteur de satisfaction</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="mb-8">
          ...
          <p className="mb-4">Le graphique ci-dessous illustre le délai moyen d'amortissement de l'investissement Sotto :</p>
            ...
            {[
              ...
              <div key={index} className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 relative overflow-hidden">
                <div className="relative z-10">
                  <p className="font-medium text-[#1A2A40] dark:text-white mb-2">{item.type}</p>
        ...
        <div>
          ...
          <p className="mb-4">En considérant l'ensemble des économies et gains générés, le ROI moyen à 24 mois s'établit à :</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              <h4 className="text-lg font-semibold mb-3 text-[#1A2A40]">Économies directes</h4>
              <p className="text-gray-700 dark:text-gray-300 mb-2">(matériel, maintenance, formation)</p>
              <div className="text-3xl font-bold text-[#D47D5A]">9 700€</div>
            </div>
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              <h4 className="text-lg font-semibold mb-3 text-[#1A2A40]">Gains liés à l'efficacité opérationnelle</h4>
              <p className="text-gray-700 dark:text-gray-300 mb-2">&nbsp;</p>
              <div className="text-3xl font-bold text-[#D47D5A]">22 400€</div>
            </div>
            <div className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300">
              <h4 className="text-lg font-semibold mb-3 text-[#1A2A40]">Augmentation du chiffre d'affaires</h4>
              <p className="text-gray-700 dark:text-gray-300 mb-2">&nbsp;</p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <blockquote className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-6 shadow-md border-t-4 border-[#D4B483]">
            <p className="italic mb-4 text-lg">"Après 10 mois d'utilisation, je peux affirmer que Sotto a transformé notre établissement. Non seulement nous avons augmenté notre chiffre d'affaires de 13%, mais l'ambiance est plus détendue, plus humaine. Mes serveurs se concentrent sur l'essentiel : l'accueil et le conseil."</p>
            <footer className="font-medium">— Thomas R., propriétaire d'une brasserie à Lyon</footer>
          </blockquote>
          
          <blockquote className="bg-[#F5F5F0] dark:bg-gray-800 rounded-lg p-6 shadow-md border-t-4 border-[#D4B483]">
            <p className="italic mb-4 text-lg">"En tant que restaurant gastronomique, nous étions réticents à adopter une technologie vocale, craignant qu'elle ne perturbe l'atmosphère feutrée que nous cultivons. Sotto s'est révélé être exactement l'inverse : discret, élégant, il a permis à notre équipe d'être encore plus présente pour nos clients."</p>
            <footer className="font-medium">— Claire D., directrice d'un restaurant étoilé</footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <p className="mb-6">Notre analyse a identifié plusieurs facteurs déterminants dans l'optimisation du ROI :</p>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <a href="#" className="group block bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border-b-2 border-transparent hover:border-[#D47D5A]">
            <h4 className="font-semibold mb-2 group-hover:text-[#D47D5A] transition-colors duration-300">Simulation personnalisée</h4>
            <p className="text-gray-700 dark:text-gray-300">Demandez une simulation personnalisée du ROI pour votre établissement</p>
          </a>
          <a href="#" className="group block bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border-b-2 border-transparent hover:border-[#D47D5A]">
            <h4 className="font-semibold mb-2 group-hover:text-[#D47D5A] transition-colors duration-300">Guide complet</h4>
            <p className="text-gray-700 dark:text-gray-300">Téléchargez notre guide complet d'optimisation du ROI avec Sotto</p>
          </a>
          <a href="#" className="group block bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-lg transition-all duration-300 border-b-2 border-transparent hover:border-[#D47D5A]">
            <h4 className="font-semibold mb-2 group-hover:text-[#D47D5A] transition-colors duration-300">Ateliers dédiés</h4>
            <p className="text-gray-700 dark:text-gray-300">Rencontrez nos experts lors de nos prochains ateliers dédiés à la transformation digitale</p>
          </a>
        </div>
      </section>

      <div className="text-center italic text-gray-600 dark:text-gray-400 pt-6 border-t border-gray-200 dark:border-gray-700">
