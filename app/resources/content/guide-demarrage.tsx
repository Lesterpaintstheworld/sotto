  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 bg-[#F5F5F0] rounded-xl shadow-lg text-[#1A2A40]">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="py-3 px-4 bg-[#F5F5F0]">Installation station base</td>
                    <td className="py-3 px-4 bg-[#F5F5F0]">45 min</td>
                    <td className="py-3 px-4 bg-[#F5F5F0]">Mise en place du hub central Sotto</td>
                  </tr>
                  <tr className="border-b border-gray-200">
                    <td className="py-3 px-4 bg-[#F5F5F0]">Configuration système</td>
                    <td className="py-3 px-4 bg-[#F5F5F0]">60 min</td>
                    <td className="py-3 px-4 bg-[#F5F5F0]">Paramétrage selon votre menu et votre organisation</td>
                  </tr>
                  <tr>
                    <td className="py-3 px-4 bg-[#F5F5F0] rounded-bl-lg">Test de couverture</td>
                    <td className="py-3 px-4 bg-[#F5F5F0]">30 min</td>
                    <td className="py-3 px-4 bg-[#F5F5F0] rounded-br-lg">Vérification de la qualité audio dans tout l'établissement</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              ...
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Création des comptes pour chaque membre du personnel</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="text-[#D4B483] mr-3">●</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Cartographie de votre restaurant (salle, terrasse, bar, cuisine)</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="text-[#D4B483] mr-3">●</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Adaptation des notifications selon vos préférences</p>
                </div>
              </li>
            </ul>
          </div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Session de formation initiale</h3>
            <p className="mb-4 text-[#1A2A40]/80">Une session de formation d'environ 2 heures sera organisée avec votre équipe, couvrant :</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Période d'adaptation guidée</h3>
            <p className="mb-4 text-[#1A2A40]/80">Nous recommandons une période d'adaptation progressive :</p>
            
            <div className="flex flex-col md:flex-row gap-4 mt-4">
              <div className="bg-[#F5F5F0] p-4 rounded-lg flex-1">
                ...
                <p className="text-sm text-[#1A2A40]/70">Utilisation en parallèle avec votre système actuel</p>
              </div>
              <div className="bg-[#F5F5F0] p-4 rounded-lg flex-1">
                <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-[#1A2A40]/70">Transition progressive vers Sotto comme système principal</p>
              </div>
              <div className="bg-[#F5F5F0] p-4 rounded-lg flex-1">
                <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-[#1A2A40]/70">Utilisation complète avec supervision de notre équipe</p>
              </div>
              <div className="bg-[#F5F5F0] p-4 rounded-lg flex-1">
                <div className="flex items-center mb-2">
                ...
                <p className="text-sm text-[#1A2A40]/70">Autonomie avec support à distance disponible</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Port et confort</h3>
            <p className="mb-4 text-[#1A2A40]/80">Les oreillettes Sotto sont conçues pour un confort optimal pendant de longues périodes :</p>
            ...
            <ul className="space-y-4 mt-4">
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">L'oreillette se place dans l'oreille droite ou gauche selon votre préférence</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="font-bold text-[#D47D5A] mr-3">→</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Trois tailles d'embouts silicone sont fournies pour s'adapter à chaque morphologie</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="font-bold text-[#D47D5A] mr-3">→</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Leur design minimaliste les rend presque invisibles aux clients</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Gestion de la batterie</h3>
            <p className="mb-4 text-[#1A2A40]/80">Les oreillettes Sotto offrent une autonomie de 8 heures en utilisation continue :</p>
            ...
            <ul className="space-y-4 mt-4">
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Une alerte discrète vous prévient 30 minutes avant épuisement</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="font-bold text-[#D47D5A] mr-3">→</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">15 minutes de charge = 2 heures d'autonomie</p>
                </div>
              </li>
              <li className="bg-[#F5F5F0] p-4 rounded-lg flex items-start">
                <span className="font-bold text-[#D47D5A] mr-3">→</span>
                <div>
                  ...
                  <p className="text-sm mt-1 text-[#1A2A40]/70">Pour les services longs, nous recommandons une rotation des oreillettes à mi-service</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Station de charge</h3>
            <p className="mb-4 text-[#1A2A40]/80">La station de charge peut accueillir jusqu'à 8 oreillettes simultanément :</p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Activation et désactivation</h3>
            <p className="mb-4 text-[#1A2A40]/80">Pour commencer à interagir avec Sotto :</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Prise de commande</h3>
            <p className="mb-4 text-[#1A2A40]/80">Pour enregistrer les commandes des clients :</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Communication cuisine-salle</h3>
            <p className="mb-4 text-[#1A2A40]/80">Pour faciliter la coordination entre les équipes :</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Gestion des additions</h3>
            <p className="mb-4 text-[#1A2A40]/80">Pour finaliser le service :</p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Mode accompagné</h3>
            <p className="mb-4 text-[#1A2A40]/80">Pendant vos premiers jours d'utilisation, Sotto fonctionnera en "mode accompagné" :</p>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Gestion des erreurs</h3>
            <p className="mb-4 text-[#1A2A40]/80">Si Sotto ne comprend pas correctement une commande :</p>
            ...
            <div className="mt-6">
              <p className="mb-2 text-[#1A2A40]/80">Exemple :</p>
              <div className="bg-[#1A2A40] text-[#F5F5F0] p-4 rounded-lg font-mono text-sm overflow-x-auto">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Feedback et amélioration</h3>
            <p className="mb-4 text-[#1A2A40]/80">Sotto apprend continuellement de vos interactions :</p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-8">
          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Support quotidien</h3>
            <p className="mb-4 text-[#1A2A40]/80">En cas de question ou difficulté :</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="bg-[#F5F5F0] p-4 rounded-lg">
                ...
                <p className="text-sm text-[#1A2A40]/70">Dites "Hey Sotto, j'ai besoin d'aide" pour une assistance immédiate</p>
              </div>
              <div className="bg-[#F5F5F0] p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#D47D5A] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-sm text-[#1A2A40]/70">Accessible via l'application mobile Sotto Support</p>
              </div>
              <div className="bg-[#F5F5F0] p-4 rounded-lg">
                <div className="flex items-center mb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-[#D47D5A] mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <p className="text-sm text-[#1A2A40]/70">Ligne téléphonique disponible 7j/7 de 8h à 23h</p>
              </div>
            </div>
          </div>

          <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
            <h3 className="text-2xl font-medium text-[#1A2A40] mb-4">Mises à jour du système</h3>
            <p className="mb-4 text-[#1A2A40]/80">Sotto s'améliore constamment :</p>
      ...
      <section className="mb-12">
        ...
        <div className="bg-white rounded-xl p-6 shadow-md transform transition-all hover:scale-[1.01]">
          <p className="mb-6 text-[#1A2A40]/80">Une fois à l'aise avec les fonctionnalités de base, découvrez les capacités avancées de Sotto :</p>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-[#F5F5F0] p-5 rounded-lg border-l-4 border-[#D47D5A] shadow-sm hover:shadow-md transition-all">
              <h4 className="text-lg font-medium text-[#1A2A40] mb-2">Gestion des réservations</h4>
              <p className="text-[#1A2A40]/70">par commande vocale</p>
            </div>
            <div className="bg-[#F5F5F0] p-5 rounded-lg border-l-4 border-[#D47D5A] shadow-sm hover:shadow-md transition-all">
              <h4 className="text-lg font-medium text-[#1A2A40] mb-2">Analyse des performances</h4>
              <p className="text-[#1A2A40]/70">via le tableau de bord</p>
            </div>
            <div className="bg-[#F5F5F0] p-5 rounded-lg border-l-4 border-[#D47D5A] shadow-sm hover:shadow-md transition-all">
              <h4 className="text-lg font-medium text-[#1A2A40] mb-2">Intégration avec votre système de fidélité</h4>
              <p className="text-[#1A2A40]/70">existant</p>
            </div>
            <div className="bg-[#F5F5F0] p-5 rounded-lg border-l-4 border-[#D47D5A] shadow-sm hover:shadow-md transition-all">
              <h4 className="text-lg font-medium text-[#1A2A40] mb-2">Personnalisation avancée</h4>
              <p className="text-[#1A2A40]/70">des suggestions et alertes</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="bg-[#1A2A40] text-white rounded-xl p-8 shadow-lg">
